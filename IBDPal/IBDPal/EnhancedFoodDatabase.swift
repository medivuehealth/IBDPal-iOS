    ...
    private func loadEnhancedFoodDatabase() {
        allFoods = [
            ...
            EnhancedFoodItem(
                ...
                fiber: 3,
                fat: 1,
                vitamins: ["C": 15, "B6": 0.4, "K": 0.5],
                minerals: ["Potassium": 400, "Magnesium": 30, "Iron": 0.5],
                servingSize: "1 cup",
                region: "Global",
                cuisine: "International",
                ibdFriendly: true,
                fodmapLevel: "low",
                preparationMethods: ["blended", "cold"],
                benefits: "Quick energy, potassium, easy to digest",
                tags: ["banana", "smoothie", "fruit", "beverage"],
                allergens: ["none"],
                dietaryRestrictions: ["vegan", "gluten-free"],
                seasonalAvailability: ["year-round"]
            ),
            ...
            EnhancedFoodItem(
                ...
                fiber: 0,
                fat: 5,
                vitamins: ["D": 1.1, "B12": 0.6, "A": 270],
                minerals: ["Iron": 0.9, "Selenium": 15, "Phosphorus": 100],
                servingSize: "1 large egg",
                region: "Global",
                cuisine: "International",
                ibdFriendly: true,
                fodmapLevel: "low",
                preparationMethods: ["boiled", "hard-boiled"],
                benefits: "Complete protein, choline, easy to digest",
                tags: ["egg", "protein", "boiled", "complete-protein"],
                allergens: ["eggs"],
                dietaryRestrictions: ["gluten-free"],
                seasonalAvailability: ["year-round"]
            ),
            ...
            EnhancedFoodItem(
                ...
                fiber: 2,
                fat: 12,
                vitamins: ["B3": 8, "B6": 0.8, "B12": 0.3],
                minerals: ["Iron": 2.5, "Zinc": 2, "Selenium": 25],
                servingSize: "1 sandwich",
                region: "Global",
                cuisine: "International",
                ibdFriendly: true,
                fodmapLevel: "low",
                preparationMethods: ["grilled", "roasted", "pan-fried"],
                benefits: "Lean protein, B vitamins, iron",
                tags: ["chicken", "sandwich", "protein", "bread"],
            ...
            EnhancedFoodItem(
                ...
                fiber: 3,
                fat: 10,
                vitamins: ["B3": 6, "B6": 0.6, "C": 8],
                minerals: ["Iron": 2, "Zinc": 1.5, "Sodium": 400],
                servingSize: "1 tortilla",
                region: "Americas",
                cuisine: "Mexican",
                ibdFriendly: true,
                fodmapLevel: "low",
                preparationMethods: ["grilled", "wrapped", "heated"],
                benefits: "Lean protein, fiber, B vitamins",
                tags: ["chicken", "tortilla", "mexican", "protein"],
                allergens: ["gluten"],
                dietaryRestrictions: ["none"],
                seasonalAvailability: ["year-round"]
            ),
            ...
            EnhancedFoodItem(
                ...
                ibdFriendly: true,
                fodmapLevel: "low",
                preparationMethods: ["boiled", "steamed", "fried"],
                benefits: "Easy to digest, energy source, low fiber",
                tags: ["rice", "grain", "carbohydrate", "staple"],
                allergens: ["none"],
                dietaryRestrictions: ["vegan", "gluten-free"],
                seasonalAvailability: ["year-round"]
            ),
            ...
            EnhancedFoodItem(
                ...
                fiber: 2,
                fat: 12,
                vitamins: ["B12": 0.5, "D": 0.2, "K": 2],
                minerals: ["Calcium": 200, "Iron": 1.5, "Sodium": 600],
                servingSize: "1 slice",
                region: "Europe",
                cuisine: "Italian",
                ibdFriendly: false,
                fodmapLevel: "high",
                preparationMethods: ["baked", "oven-cooked"],
                benefits: "Calcium, protein, comfort food",
                tags: ["pizza", "cheese", "italian", "dairy"],
                allergens: ["gluten", "dairy"],
                dietaryRestrictions: ["none"],
                seasonalAvailability: ["year-round"]
            )
